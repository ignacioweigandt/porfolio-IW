...
const ScrollStack = ({
    ...
    cardsRef.current.forEach((card, i) => {
      ...
      if (blurAmount) {
        ...
        for (let j = 0; j < cardsRef.current.length; j++) {
          const jCardElement = cardsRef.current[j] as HTMLElement;
          const jCardTop = jCardElement.offsetTop;
  ...
  useLayoutEffect(() => {
    ...
    cards.forEach((card, i) => {
      ...
      cardElement.style.willChange = 'transform, filter';
      ...
      cardElement.style.webkitTransform = 'translateZ(0)';
      cardElement.style.perspective = '1000px';
      cardElement.style.webkitPerspective = '1000px';
    });
